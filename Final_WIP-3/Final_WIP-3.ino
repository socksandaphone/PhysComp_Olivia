...
const int threshold = 40000;  // threshold for touch buttons
...
Servo toyServo;  //create instance of Servo library object
Servo treatServo;
// set pin numbers
...
void setup() {
  toyServo.attach(servoPin1); // attach servo object to physical pin
  treatServo.attach(servoPin2);
...
void playVid() {
  ...
  // send to processing someting to change vid
}
